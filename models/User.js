...
userSchema.methods.comparePassword = function(palinPassword, cb) {
    ...
    //palinPassword 1234567     암호화된 비밀번호는 
...
userSchema.methods.generateToken = function(cb) {
    ...
    var toekn = jwt.sign(user._id.toHexString(), 'secretToken')

    // user._id + 'secretToken' = token
    // 'secertToken' -> uesr._id
...
userSchema.statics.findByToken = function(token, cb) {
    ...
    // user._id + '' = toekn
    // 토큰을 decode 한다.
    jwt.verify(toekn, 'secretToken', function(err, decode) {
